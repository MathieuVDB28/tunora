  ...
  if (!isPaid) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border py-16">
        ...
        <h3 className="mb-2 text-lg font-semibold">Fonctionnalite Pro</h3>
        <p className="mb-6 max-w-sm text-center text-muted-foreground">
          Passe en Pro pour obtenir des recommandations d&apos;albums personnalisees basees sur tes ecoutes
        </p>
        <a
          href="/settings"
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border py-16">
        ...
        <p className="max-w-sm text-center text-muted-foreground">
          Ajoute des albums ecoutes pour recevoir des recommandations personnalisees
        </p>
      </div>
    );
  }
